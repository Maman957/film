...
class ProdukModel extends CI_Model
{
    ...
    {
        return $this->db->query('SELECT produk.id_produk,produk.gambar,produk.nama_produk,produk.harga_jual FROM produk, keranjang WHERE produk.id_produk=keranjang.id_produk;');
    }
