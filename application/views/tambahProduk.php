                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <form method="post" action="<?= base_url('simpan_produk') ?>" enctype="multipart/form-data" class="tm-edit-product-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="kategori" name="kategori" required>
                        ...
                        <div class="input-group mb-3">
                            <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                <a href="<?= base_url('produk') ?>"><button type="button" class="btn btn-danger">Kembali
                                    </button></a>
                            </div>
                        </div>
                </div>
