        ...
        <div class="bg-white tm-block">
            <div class="row mt-4">
                ...
                <div class="col-xl-3 col-lg-3 mb-4 mx-auto">
                    <center>
                        <div class="tm-product-img-dummy">
                            <form method="post" action="<?= base_url('simpan_foto') ?>" enctype="multipart/form-data" class="tm-edit-product-form">
                ...
                <div class="col-xl-8 col-lg-8 col-md-12">
                    ...
                    <form method="post" action="<?= base_url('update_pengguna') ?>" class="tm-edit-product-form">
                        <input type="hidden" name="id_pengguna" value="<?= $pengguna['id_pengguna'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-8 tm-btn-right">
                                <button onclick="konfirmHapus(<?= $pengguna['id_pengguna'] ?>)" type="button" class="btn btn-danger">Hapus Akun
                                </button>
                            </div>
                        </div>
                    </form>
